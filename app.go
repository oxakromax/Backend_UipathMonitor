...
func routes(e *echo.Echo, H *Server.Handler) {
	...
	e.POST("/admin/processes/:id/users", H.AddUsersToProcess)
	e.GET("/admin/processes/:id/possibleUsers", H.GetPossibleUsers)
	e.DELETE("/admin/processes/:id/users", H.DeleteUsersFromProcess)
